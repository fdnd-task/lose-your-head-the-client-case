...
<main>
    ...
    <section class="header-main">
        ...
        <h1>{homepage.introMain.subTitle}</h1>
        <h1>{homepage.introMain.subTitle2}</h1>
    </section>
...
<section class="legends">
    <h2>Meet our future <span>legends</span> </h2>
...
<section class="numbers">
    <div class="text-area">
        <h2 class="numbers-header">We are growing and the <span class="yellow">numbers</span> speak for it</h2>
        <p>Pellentesque pellentesque dignissim vulputate tincidunt. Dis a nec pulvinar potenti elit feugiat quis
            nunc est. Sit diam laoreet pellentesque vitae vitae at dui.</p>
    </div>
        ...
        <div class="numbers-wrapper">
            ...
            <div class="children-saved shapes">
                <div class="single-number-wrapper">
                    <div class="stats-numbers nr358">358</div>
                </div>
            ...
            <div class="talents-discovered shapes">
                <clipPath id="talents-discovered-clip">
                    ...
                    <div class="stats-numbers nr12">12</div>
            ...
            <div class="new-partners shapes">
                <clipPath id="new-partners-clip">
                    ...
                    <div class="stats-numbers nr04">4</div>
                    <p>New partners</p>
            </div>
            ...
            <div class="clubs-invested shapes">
                <clipPath id="clubs-invested-clip">
                    ...
                    <div class="stats-numbers nr08">8</div>
                    <p>Clubs invested</p>
            </div>
        </div>
...
.story-video video {
    -webkit-mask-image: url(./story-shape.svg);
...
.option3 {
    position: absolute;
    right: 18%;
    /* transform: translateX(51%) translateY(3%); */
}
...
@media only screen and (max-width: 600px){
    ...
    .hero-play-button button {
        margin: 0;
    }

    .hero-title span {
        font-size: clamp(36px, 12.5vw, 128px);
    }

    .hero-title-where span:nth-of-type(1),
    .hero-title-where span:nth-of-type(2),
    .hero-title-the-real>div:nth-of-type(2) span:nth-of-type(2) {
        font-size: clamp(2rem, 16vw, 168px);
    }

    .hero-title-legends span {
        font-size: clamp(40px, 14vw, 144px);
        opacity: 0;
        transform: scale(5);
    }
    ...
    .hero-title-legends span:nth-of-type(4) {
        font-size: clamp(29px, 10vw, 104px);
    }
    ...
    .news-card{
        width: clamp(150px, 28%, 28%);
        height: clamp(170px, 31vw, 31vw);
    }
...
@media only screen and (max-width: 600px) {
    ...
    /* ============== NUMBERS SECTION END MOBILE ============== */

    #legends-marquee {
        font-size: 5em;
        transform: translateX(calc((-80% + 100vw) * var(--x)));
    }
