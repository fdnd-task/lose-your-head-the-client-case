...
<a class="card {status}" href={programLink}>
    <picture class="image">
        <img src=https://fdnd-agency.directus.app/assets/{imgSrc} alt={programName} />
    </picture>
